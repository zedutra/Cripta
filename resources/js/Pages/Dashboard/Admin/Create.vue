<template>
  <div>
    ...
    <Head title="Cadastrar Admin" />
    <h1 class="mb-8 text-3xl font-bold">
      <Link class="text-indigo-400 hover:text-indigo-600" :href="route('painel.user.index')">Admin</Link>
...
export default {
  ...
  methods: {
    store() {
      this.form.post(route('painel.admin.store'))
    },
  },
}
</script>
